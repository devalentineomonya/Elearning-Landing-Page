...
const OurPartners = () => {
  return (
    <div className="w-full h-fit lg:h-[60vh] bg-gray-200  rounded-xl flex items-center flex-col py-24">
      <h1 className="text-3xl sm:text-4xl md:text-5xl whitespace-nowrap   font-semibold text-slate-900  ">
        We connect worlds Career Exparts
      </h1>
      <h1 className="text-3xl sm:text-4xl md:text-5xl whitespace-nowrap font-semibold text-slate-900 mt-4 ">
